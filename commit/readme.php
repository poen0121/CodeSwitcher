...
>> Commit
	...
	Control events end program relies on the version control mechanism.

	Event script execution will work together.

	You can control the event script to commit the output view.

	You can do some shutdown function.
